    ...
    <div class="table">
      ...
      <!--        操作        -->
            <template slot-scope="{ row }" slot="action">
                  <Button type="text" size="small" @click="details(row)">详情</Button>
         ...
         >
          ...
          <div class="detalInfo">
               <div class="infoRow">
                ...
                <div class="infoRow">
                  <span class="text"> 身份证号码名 : </span>
                   <span > 232323232232332 </span>
                </div>
          </div>
           <div class="detalImg">
             <p class="imgText">身份证正反面照片</p>
               <div class="detalCard">
                  <img src="@/assets/img/card.png" alt="" class="imgCard">
                  <img src="@/assets/img/sideCard.png" alt=""  class="imgCards">
                </div>
               
          </div>
                  </Tab-pane>
                  <Tab-pane label="作品信息" name="name2">
            <template>
                <Table border size="large" :columns="columns1" :data="data1"></Table>
            </template>
             <!-- 分页 -->
     <div class="page text-right">
      <Page
      ...
      <template>
        ...
        :title="modalTitle1"
         ...
         >
               ...
               <p>操作备注</p>
                  <template>
                         <Input v-model="value6" type="textarea" :rows="4" placeholder="请输入文本内容" class="editIpnut"></Input>
                  </template>
         </Modal>
      </template>
  </div>
